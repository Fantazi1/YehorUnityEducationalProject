...
public class InventoryUI : MonoBehaviour
{
    ...
    {
        InventorySlotData data = slot.Area == InventorySlotArea.Result ?
            _inventorySystem.GetCraftingResult() :
            _inventorySystem.GetSlot(slot.Area, slot.Index);
        ...
        _dragIcon = CreateImage("DragIcon", _canvasObject.transform, data.Item.IconColor);
    ...
    public void Drag(InventorySlotUI slot, PointerEventData eventData)
    {
        ...
        if (eventData.delta.sqrMagnitude > 0.01f) _wasDragging = true;
    ...
    private void CreateInventoryWindow()
    {
        ...
        CreateText(
            "InventoryHint",
            _inventoryPanel.transform,
            "ЛКМ — взяти/положити   ПКМ — половина   Shift + ПКМ — точна кількість",
            15,
            TextAnchor.MiddleCenter,
            new Vector2(0f, -260f),
    ...
    private void CreateCursorUI()
    {
        ...
        _cursorObject.GetComponent<Image>().raycastTarget = false;
        ...
        _cursorItemName = CreateText(
            ...
            new Vector2(8f, 0f),
            new Vector2(70f, 55f));
        _cursorItemName.raycastTarget = false;
    ...
    private void UpdateCursorUI()
    {
        ...
        if (_cursorItemName == null || _cursorAmount == null || _cursorObject == null) return;
        ...
        if (Mouse.current != null)
        {
            ...
            _cursorObject.GetComponent<RectTransform>().anchoredPosition = localPoint + new Vector2(15f, -15f);
        }
    }
    ...
    private void SetOpen(bool value)
    {
        ...
        if (_inventoryPanel != null) _inventoryPanel.SetActive(value);
        if (!value && _splitPanel != null) CloseSplitWindow();

        // Шукаємо гравця на сцені та кажемо йому, чи відкритий інвентар
        var playerController = Object.FindFirstObjectByType<FirstPersonController>();
        if (playerController != null)
        {
            playerController.isUIOpen = value;
        }

        if (value)
        {
            // Показуємо і розблоковуємо системний курсор
        ...
        {
            // Ховаємо системний курсор при закритті інвентарю
